...
export const BUDDIES = [
  { id: "mochi", name: "Mochi Cat", animalKey: "animal.cat", supplierVariant: "Cat", image: "assets/img/products/buddy-cat", accent: "var(--yellow)", accentSoft: "var(--yellow-soft)", badgeKey: null, family: "pets" },
  { id: "coco", name: "Coco Pup", animalKey: "animal.dog", supplierVariant: "Dog", image: "assets/img/products/buddy-dog", accent: "#f5a54a", accentSoft: "#ffeed8", badgeKey: null, family: "pets" },
  { id: "ellie", name: "Ellie Elephant", animalKey: "animal.elephant", supplierVariant: "Grey elephant", image: "assets/img/products/buddy-elephant", accent: "var(--mint)", accentSoft: "var(--mint-soft)", badgeKey: "badge.bestseller", family: "zoo" },
  { id: "mango", name: "Mango Monkey", animalKey: "animal.monkey", supplierVariant: "Monkey", image: "assets/img/products/buddy-dog", accent: "var(--coral)", accentSoft: "var(--coral-soft)", badgeKey: "badge.new", family: "zoo" },
  { id: "chili", name: "Chili Red Panda", animalKey: "animal.redpanda", supplierVariant: "Red panda", image: "assets/img/products/buddy-bear", accent: "#ff8a5b", accentSoft: "#ffe8de", badgeKey: "badge.new", family: "zoo" },
  { id: "bao", name: "Bao Panda", animalKey: "animal.panda", supplierVariant: "Panda", image: "assets/img/products/buddy-elephant", accent: "#c4b8a8", accentSoft: "#f5f1ea", badgeKey: null, family: "zoo" },
  { id: "dino-mint", name: "Dino Mint", animalKey: "animal.dino", supplierVariant: "Green dinosaur", image: "assets/img/products/buddy-dino-mint", accent: "var(--green)", accentSoft: "var(--green-soft)", badgeKey: null, family: "dinos" },
  { id: "dino-grape", name: "Dino Grape", animalKey: "animal.dino", supplierVariant: "Purple dinosaur", image: "assets/img/products/buddy-dino-grape", accent: "var(--purple)", accentSoft: "var(--purple-soft)", badgeKey: "badge.new", family: "dinos" },
  { id: "flip", name: "Flip Frog", animalKey: "animal.frog", supplierVariant: "Frog", image: "assets/img/products/buddy-dino-mint", accent: "#8CC63F", accentSoft: "#e9f6d8", badgeKey: "badge.new", family: "cartoons" },
  { id: "blossom", name: "Blossom Bunny", animalKey: "animal.bunny", supplierVariant: "Bunny pink", image: "assets/img/products/buddy-cat", accent: "#E95E8A", accentSoft: "#ffe3ea", badgeKey: "badge.new", family: "cartoons" },
];
